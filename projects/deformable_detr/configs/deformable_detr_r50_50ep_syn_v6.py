...
dataloader = get_config("common/data/sugarbeets_syn.py").dataloader
...
train.output_dir = "/netscratch/naeem/attention_maps_v6/phenobench_deformable_detr_syn_v6_baseline"

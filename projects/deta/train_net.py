...
def main(args):
    ...
    if args.aug_index>0:
        ...
        cfg['train'].output_dir = os.path.join(cfg['train'].output_dir, 'phenobench_def_detr_syn_v6_aug_'+augmentation_name)
    # if args.subset_index != 100:
    #     cfg['dataloader']['train']['dataset']['names'] = "syn_pheno_train_{}".format(args.subset_index)
    #     cfg['train'].output_dir = cfg['train'].output_dir + '_subset_{}'.format(args.subset_index)
